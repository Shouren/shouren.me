...
(function(a, d, f, c, j) {
    ...
    var h = MathJax.Extension.MathZoom = {
        ...
        Resize: function(m) {
            ...
            var r = document.getElementById("MathJax_ZoomFrame"), l = document.getElementById("MathJax_ZoomOverlay");
            var o = h.getXY(r);
            var n = r.parentNode, q = h.getOverflow(n);
    ...
    MathJax.Callback.Queue(["StartupHook", MathJax.Hub.Register, "Begin Styles", {}
    ], ["Styles", f, i.styles], ["Post", a.Startup.signal, "MathZoom Ready"], ["loadComplete", f, "[MathJax]/extensions/MathZoom.js"])
...
(function(c, g, k, f, b) {
    ...
    a.ShowSource.Text = function(v, t) {
        ...
        if (a.isMobile) {
            ...
            setTimeout(function() {
                var A = (r.outerHeight - r.innerHeight) || 30, z = (r.outerWidth - r.innerWidth) || 30, w, B;
...
(function(a) {
    a.mbase = MathJax.Object.Subclass({
        ...
        childPosition: function() {
            var g = this, f = g.parent;
            while (f.notParent) {
                g = f;
                f = g.parent
            }
            for (var e = 0, d = f.data.length; e < d; e++) {
                if (f.data[e] === g) {
                    return e
                }
            }
...
(function(d, c, i) {
    ...
    var a = MathJax.Object.Subclass({
        ...
        MmlToken: function(n) {
            var o = this.GetArgument(n), l = this.GetBrackets(n, "").replace(/^\s+/, ""), r = this.GetArgument(n), q = {
                attrNames: []
            }, m;
